...
export default class Register extends React.Component {
    checkValue (username, password, confirmPassword) {
        ...
        if (username[0] === ' ' || username[username.length] === ' ') {
            message.error('用户名不允许首尾存在空格');
                ...
                <div style={{
                    ...
                    <Form horizontal>
                        ...
                        <FormItem
                            ...
                            <Input type="password" ref="confirmPassword" placeholder="重复密码" onKeyDown={ e => { if(e.keyCode === 13) this.refs.send.props.onClick(); }}/>
                        </FormItem>
                    </Form>
                    <Button 
                        amStyle="primary" 
